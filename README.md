...
I specialize in architecting end-to-end systems that power high-performance intelligence. From fine-tuning models to building the scalable infrastructure they run on, I bridge the gap between complex AI research and production-ready enterprise applications.

- 🔭 I’m highly focused on building **Agentic Workflows** using LangGraph and optimizing **RAG architectures** for scale.
- 🌱 I actively research **Low-Latency Inference**, **Vector Database Optimization** (Neo4j, Redis), and **Distributed System Design**.
- 💬 Ask me about **Next.js, Python, multi-agent orchestration, or ML-driven recruitment systems**.
...
- **[SmartHireGenAI](https://smarthiregenai.streamlit.app/)** 
  ...
  - **The Solution:** Developed a GenAI resume evaluator using Google Gemini and Vector Embeddings, achieving 92% parsing accuracy across 500+ resumes and reducing manual screening time by 60% for HR stakeholders.
